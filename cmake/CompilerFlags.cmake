...
if(MSVC AND NOT ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")) # Visual C++ (VS 2013)
  ...
  target_compile_options(project_options INTERFACE /FIXED:NO) # Position independent code
  target_compile_options(project_options INTERFACE /NXCOMPAT) # Windows Data Execution Prevention
  target_compile_options(project_options INTERFACE /DYNAMICBASE) # Address Space Layout Randomization
  target_compile_options(project_options INTERFACE /HIGHENTROPYVA) # Support high-entropy 64-bit ASLR
  target_compile_options(project_options INTERFACE /GS) # Buffer overrun detection
