...
#  however it also has a dependency on the core python dll at /usr/local/lib/libpython3.11.dylib
...
#  we change the -id from /some/path/to/Python.framework/Versions/3.7/{SomePythonLibName} to @executable_path/libpython3.11.dylib
...
execute_process(COMMAND "install_name_tool" -change "/usr/local/lib/${PYTHON_LIB_FILENAME}" "@executable_path/${PYTHON_LIB_FILENAME}" "${EXECUTABLE_PATH}")
#
